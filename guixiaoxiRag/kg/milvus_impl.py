...
import numpy as np
from guixiaoxiRag.utils import logger, compute_mdhash_id
...
class MilvusVectorDBStorage(BaseVectorStorage):
    def _create_schema_for_namespace(self) -> CollectionSchema:
        ...
        if "entities" in self.namespace.lower():
            ...
            description = "GuiXiaoXiRag entities vector storage"
            ...
            description = "GuiXiaoXiRag relationships vector storage"
            ...
            description = "GuiXiaoXiRag chunks vector storage"
            ...
            description = "GuiXiaoXiRag generic vector storage"
