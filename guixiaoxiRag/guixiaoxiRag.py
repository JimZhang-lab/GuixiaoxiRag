...
@dataclass
class GuiXiaoXiRag:
    """GuiXiaoXiRag: Simple and Fast Retrieval-Augmented Generation."""
    ...
    """If True, guixiaoxiRag will automatically calls initialize_storages and finalize_storages at the appropriate times."""
    ...
    def __post_init__(self):
        ...
        logger.debug(f"GuiXiaoXiRag init with param:\n  {_print_config}\n")
    ...
    def _get_storage_class(self, storage_name: str) -> Callable[..., Any]:
        ...
        if storage_name == "JsonKVStorage":
            from guixiaoxiRag.kg.json_kv_impl import JsonKVStorage

            return JsonKVStorage
        elif storage_name == "NanoVectorDBStorage":
            from guixiaoxiRag.kg.nano_vector_db_impl import NanoVectorDBStorage

            return NanoVectorDBStorage
        elif storage_name == "NetworkXStorage":
            from guixiaoxiRag.kg.networkx_impl import NetworkXStorage

            return NetworkXStorage
        elif storage_name == "JsonDocStatusStorage":
            from guixiaoxiRag.kg.json_doc_status_impl import JsonDocStatusStorage
