"""
Configs for the GuiXiaoXiRag API.
"""
...
from guixiaoxiRag.llm.binding_options import OllamaEmbeddingOptions, OllamaLLMOptions
import sys
...
class OllamaServerInfos:
    def __init__(self, name=None, tag=None):
        self._guixiaoxiRag_name = name or os.getenv(
            "OLLAMA_EMULATING_MODEL_NAME", DEFAULT_OLLAMA_MODEL_NAME
        )
        self._guixiaoxiRag_tag = tag or os.getenv(
    ...
    def LIGHTRAG_NAME(self):
        return self._guixiaoxiRag_name

    @LIGHTRAG_NAME.setter
    def LIGHTRAG_NAME(self, value):
        self._guixiaoxiRag_name = value

    @property
    def LIGHTRAG_TAG(self):
        return self._guixiaoxiRag_tag

    @LIGHTRAG_TAG.setter
    def LIGHTRAG_TAG(self, value):
        self._guixiaoxiRag_tag = value

    @property
    def LIGHTRAG_MODEL(self):
        return f"{self._guixiaoxiRag_name}:{self._guixiaoxiRag_tag}"
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="GuiXiaoXiRag FastAPI Server with separate working and input directories"
    )
    ...
    parser.add_argument(
        ...
        help="API key for authentication. This protects guixiaoxiRag server against unauthorized access",
    )
    ...
    parser.add_argument(
        ...
        help="Name for the simulated Ollama model (default: from env or guixiaoxiRag)",
    )
    ...
    args.token_secret = get_env_value("TOKEN_SECRET", "guixiaoxiRag-jwt-default-secret")
