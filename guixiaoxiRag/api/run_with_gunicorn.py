#!/usr/bin/env python
"""
Start GuiXiaoXiRag server with Gunicorn
"""
...
from guixiaoxiRag.api.utils_api import display_splash_screen, check_env_file
from guixiaoxiRag.api.config import global_args
from guixiaoxiRag.utils import get_env_value
from guixiaoxiRag.kg.shared_storage import initialize_share_data, finalize_share_data
...
def main():
    ...
    print("🚀 Starting GuiXiaoXiRag with Gunicorn")
    ...
    class GunicornApp(BaseApplication):
        ...
        def load_config(self):
            ...
            from guixiaoxiRag.api import gunicorn_config
        ...
        def load(self):
            ...
            from guixiaoxiRag.api.guixiaoxiRag_server import get_application
