...
from guixiaoxiRag.utils import TiktokenTokenizer
from guixiaoxiRag.api.utils_api import get_combined_auth_dependency
from fastapi import Depends


# query mode according to query prefix (bypass is not GuiXiaoXiRag quer mode)
...
class OllamaAPI:
    def __init__(self, rag: GuiXiaoXiRag, top_k: int = 60, api_key: Optional[str] = None):
        self.rag = rag
    ...
    def setup_routes(self):
        ...
        async def generate(raw_request: Request):
            ...
            For compatibility purpose, the request is not processed by GuiXiaoXiRag,
        ...
        async def chat(raw_request: Request):
            ...
            Routes user queries through GuiXiaoXiRag by selecting query mode based on prefix indicators.
