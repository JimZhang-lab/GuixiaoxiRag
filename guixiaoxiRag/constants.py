"""
Centralized configuration constants for GuiXiaoXiRag.

This module defines default values for configuration constants used across
different parts of the GuiXiaoXiRag system. Centralizing these values ensures
...
DEFAULT_OLLAMA_DIGEST = "sha256:guixiaoxiRag"
