...
if TYPE_CHECKING:
    from core.rag.base import BaseKVStorage, QueryParam
...
class LightragPathFilter(logging.Filter):
    """Filter for core.rag logger to filter out frequent path access logs"""
...
def setup_logger(
    ...
    Args:
        ...
        log_file_path: Path to the log file. If None and file logging is enabled, defaults to core.rag.log in LOG_DIR or cwd
...
def check_storage_env_vars(storage_name: str) -> None:
    ...
    """
    from core.rag.kg import STORAGE_ENV_REQUIREMENTS
