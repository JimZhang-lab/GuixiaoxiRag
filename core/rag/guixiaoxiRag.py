...
from core.rag.utils import get_env_value

from core.rag.kg import (
    STORAGES,
...
if TYPE_CHECKING:
    from core.rag.api.config import OllamaServerInfos

from core.rag.kg.shared_storage import (
    get_namespace_data,
...
# allows to use different .env file for each core.rag instance
...
class GuiXiaoXiRag:
    ...
    """If True, core.rag will automatically calls initialize_storages and finalize_storages at the appropriate times."""
    ...
    def _get_storage_class(self, storage_name: str) -> Callable[..., Any]:
        ...
        if storage_name == "JsonKVStorage":
            from core.rag.kg.json_kv_impl import JsonKVStorage

            return JsonKVStorage
        elif storage_name == "NanoVectorDBStorage":
            from core.rag.kg.nano_vector_db_impl import NanoVectorDBStorage

            return NanoVectorDBStorage
        elif storage_name == "NetworkXStorage":
            from core.rag.kg.networkx_impl import NetworkXStorage

            return NetworkXStorage
        elif storage_name == "JsonDocStatusStorage":
            from core.rag.kg.json_doc_status_impl import JsonDocStatusStorage
